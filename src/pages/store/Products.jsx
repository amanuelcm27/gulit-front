      ...
      <div className=" max-sm:m-1 m-10 relative">
        <div className={`absolute z-10 bg-white bg-opacity-95 max-sm:w-full w-1/4 h-full transition-transform duration-500 ${showFilterSideBar ? 'translate-x-0' : '-translate-x-[500px]'}`}>
          <div className="flex flex-col m-8">
            <span onClick={()=>setShowFilterSideBar(false)} className="ml-auto hover:scale-110 cursor-pointer">
        ...
        <div className="h-[80px] flex items-center p-2 bg-gray-100">
          <div onClick={()=>setShowFilterSideBar(true)} className="p-2 hover:bg-gray-200 cursor-pointer">
