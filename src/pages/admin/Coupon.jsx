    ...
    <>
      ...
      <div className="w-[85%] h-[600px] ">
        <div className="h-full overflow-y-scroll">
          ...
          />) :
          <EmptyCard text="Your store doesn't have any coupons yet." btext="Add Coupons" handleClick={() => setExpandCouponForm(!couponForm)} />}
        </div>
      </div>
      {couponForm && (
      ...
      {deleteBox && (
        <div className="absolute flex justify-center items-center right-0 w-full h-[600px] bg-white bg-opacity-95">
          <div className="w-[40%] h-[200px] border-red-400  bg-white flex flex-col border-2 rounded-md">
            ...
            <span className="text-gray-400 mx-4 text-sm">once this done users can no longer use this coupon !</span>
            <div className="flex flex-col m-4 h-full">
              <div className="flex w-full ">
                <span className="w-1/2 flex-1 truncate ">{itemToDelete.product ? itemToDelete.product.name : 'For Products in Cart'}</span>
              ...
              <div className="flex mt-auto">
                ...
                />
                <SubmitButton
                  handleSubmit={()=>{deleteCoupon(itemToDelete.id)  , setDeleteBox(false)}}
                  name={`I'm Sure`}
