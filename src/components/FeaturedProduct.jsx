...
const FeaturedProduct = () => {
  return (
    <div className=" max-sm:w-full w-1/4 h-[450px]  m-2 border-[1px] rounded-t-lg flex flex-col items-center transition-all duration-200 cursor-pointer hover:bg-gray-200 overflow-hidden">
      <img
        src={images.tech}
